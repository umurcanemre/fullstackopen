...
describe('favoriteAuthor blog', () => {
  ...
  test('returns undefined for undefined', () => {
    ...
    const result = listHelper.favoriteAuthor(blogs)
  ...
  test('returns author and likes of single blog for list with single blog', () => {
    const result = listHelper.favoriteAuthor([blogExampleItem])
    assert.deepStrictEqual(result, favAuthorExample)
  })
  test('returns total likes for author for list single author', () => {
    ...
    const result = listHelper.favoriteAuthor(blogs)
    assert.deepStrictEqual(result, { ...favAuthorExample, likes: 10 })
  })
